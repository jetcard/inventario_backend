...
public abstract class UpdateEspecificoAbstractHandler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
      ...
      if (body != null && !body.isEmpty()) {
        ...
        if (especifico != null) {
          if (id.equals(especifico.getId())) {
            update(especifico.getId(),
                    especifico.getResponsable(),
                    especifico.getArticulo(),
                    especifico.getTipo(),
                    especifico.getGrupo());
          } else {
            return response

...
public abstract class UpdateEspecificosAbstractHandler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
      ...
      if (body != null && !body.isEmpty()) {
        ...
        if (especificos != null) {
          if (id.equals(especificos.getId())) {
            ///update(especificos.getId(), especificos.getDescripespecifico(), especificos.getNombreespecifico());
          } else {
            return response

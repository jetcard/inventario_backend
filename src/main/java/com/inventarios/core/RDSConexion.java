...
public class RDSConexion {
  ...
  public static String rdsSecretArn() {
    return "arn:aws:secretsmanager:ap-southeast-2:905418357889:secret:RDSSecret-df5PREcKU5is-3P0Dsc";
    //return System.getenv(POSTGRES_SECRET_ARN_ENV);
  }

  public static String rdsEndpoint() {
    return "sam-app-rdsinstance-aqxfb0wzgvih.ctcosak24j76.ap-southeast-2.rds.amazonaws.com";

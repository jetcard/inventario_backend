...
public class RDSConexion {
  ...
  public static String rdsSecretArn() {
    //return "arn:aws:secretsmanager:ap-southeast-2:905418357889:secret:RDSSecret-VBaZDMAZCmfn-NqOmrB";
    return System.getenv(POSTGRES_SECRET_ARN_ENV);
  }

  public static String rdsEndpoint() {
    //return "sam-app-rdsinstance-cp7pt4izcmch.ctcosak24j76.ap-southeast-2.rds.amazonaws.com";

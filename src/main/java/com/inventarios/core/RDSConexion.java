...
public class RDSConexion {
  ...
  public static String rdsSecretArn() {
    //return "arn:aws:secretsmanager:ap-southeast-2:905418357889:secret:RDSSecret-Yw6aK9XyJI13-BhJNXT";
    return System.getenv(POSTGRES_SECRET_ARN_ENV);
  }

  public static String rdsEndpoint() {
    //return "sam-app-rdsinstance-fg90xf9n2mdz.ctcosak24j76.ap-southeast-2.rds.amazonaws.com";

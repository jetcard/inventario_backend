...
public class RDSConexion {
  ...
  public static String rdsSecretArn() {
    //return "arn:aws:secretsmanager:ap-southeast-2:905418357889:secret:RDSSecret-bSAy8a2fWQpO-PiQb2L";
    return System.getenv(POSTGRES_SECRET_ARN_ENV);
  }

  public static String rdsEndpoint() {
    //return "sam-app-rdsinstance-ivblu2pjvrfe.ctcosak24j76.ap-southeast-2.rds.amazonaws.com";
